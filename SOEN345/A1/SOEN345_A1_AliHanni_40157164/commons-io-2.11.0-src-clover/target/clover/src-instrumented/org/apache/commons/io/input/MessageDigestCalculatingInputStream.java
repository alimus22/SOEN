...
public class MessageDigestCalculatingInputStream extends ObservableInputStream {public static class __CLR4_4_14p64p6kylvdzts{public static com_atlassian_clover.CoverageRecorder R;public static com_atlassian_clover.CloverProfile[] profiles = { };@java.lang.SuppressWarnings("unchecked") public static <I, T extends I> I lambdaInc(final int i,final T l,final int si){java.lang.reflect.InvocationHandler h=new java.lang.reflect.InvocationHandler(){public java.lang.Object invoke(java.lang.Object p,java.lang.reflect.Method m,java.lang.Object[] a) throws Throwable{R.inc(i);R.inc(si);try{return m.invoke(l,a);}catch(java.lang.reflect.InvocationTargetException e){throw e.getCause()!=null?e.getCause():new RuntimeException("Clover failed to invoke instrumented lambda",e);}}};return (I)java.lang.reflect.Proxy.newProxyInstance(l.getClass().getClassLoader(),l.getClass().getInterfaces(),h);}static{com_atlassian_clover.CoverageRecorder _R=null;try{com_atlassian_clover.CloverVersionInfo.An_old_version_of_clover_is_on_your_compilation_classpath___Please_remove___Required_version_is___4_4_1();if(2019101123313948L!=com_atlassian_clover.CloverVersionInfo.getBuildStamp()){com_atlassian_clover.Clover.l("[CLOVER] WARNING: The Clover version used in instrumentation does not match the runtime version. You need to run instrumented classes against the same version of Clover that you instrumented with.");com_atlassian_clover.Clover.l("[CLOVER] WARNING: Instr=4.4.1#2019101123313948,Runtime="+com_atlassian_clover.CloverVersionInfo.getReleaseNum()+"#"+com_atlassian_clover.CloverVersionInfo.getBuildStamp());}R=com_atlassian_clover.Clover.getNullRecorder();_R=com_atlassian_clover.Clover.getNullRecorder();_R=com_atlassian_clover.Clover.getRecorder("\u002f\u0055\u0073\u0065\u0072\u0073\u002f\u0061\u006c\u0069\u0068\u0061\u006e\u006e\u0069\u002f\u0044\u0065\u0073\u006b\u0074\u006f\u0070\u002f\u0047\u0069\u0074\u0048\u0075\u0062\u002f\u0053\u004f\u0045\u004e\u002f\u0053\u004f\u0045\u004e\u0033\u0034\u0035\u002f\u0041\u0031\u002f\u0063\u006f\u006d\u006d\u006f\u006e\u0073\u002d\u0069\u006f\u002d\u0032\u002e\u0031\u0031\u002e\u0030\u002d\u0073\u0072\u0063\u002f\u0074\u0061\u0072\u0067\u0065\u0074\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002f\u0063\u006c\u006f\u0076\u0065\u0072\u002e\u0064\u0062",1642616389890L,8589935092L,6105,profiles,new java.lang.String[]{"clover.distributed.coverage",null});}catch(java.lang.SecurityException e){java.lang.System.err.println("[CLOVER] FATAL ERROR: Clover could not be initialised because it has insufficient security privileges. Please consult the Clover documentation on the security policy file changes required. ("+e.getClass()+":"+e.getMessage()+")");}catch(java.lang.NoClassDefFoundError e){java.lang.System.err.println("[CLOVER] FATAL ERROR: Clover could not be initialised. Are you sure you have Clover in the runtime classpath? ("+e.getClass()+":"+e.getMessage()+")");}catch(java.lang.Throwable t){java.lang.System.err.println("[CLOVER] FATAL ERROR: Clover could not be initialised because of an unexpected error. ("+t.getClass()+":"+t.getMessage()+")");}R=_R;}}public static final com_atlassian_clover.TestNameSniffer __CLR4_4_1_TEST_NAME_SNIFFER=com_atlassian_clover.TestNameSniffer.NULL_INSTANCE;
    ...
    public static class MessageDigestMaintainingObserver extends Observer {
         ...
         */
        public MessageDigestMaintainingObserver(final MessageDigest messageDigest) {try{__CLR4_4_14p64p6kylvdzts.R.inc(6090);
            __CLR4_4_14p64p6kylvdzts.R.inc(6091);this.messageDigest = messageDigest;
        }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}

        @Override
        public void data(final int input) throws IOException {try{__CLR4_4_14p64p6kylvdzts.R.inc(6092);
            __CLR4_4_14p64p6kylvdzts.R.inc(6093);messageDigest.update((byte) input);
        }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}

        @Override
        public void data(final byte[] input, final int offset, final int length) throws IOException {try{__CLR4_4_14p64p6kylvdzts.R.inc(6094);
            __CLR4_4_14p64p6kylvdzts.R.inc(6095);messageDigest.update(input, offset, length);
        }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}
    }
    ...
    public MessageDigestCalculatingInputStream(final InputStream inputStream, final MessageDigest messageDigest) {
        super(inputStream, new MessageDigestMaintainingObserver(messageDigest));__CLR4_4_14p64p6kylvdzts.R.inc(6097);try{__CLR4_4_14p64p6kylvdzts.R.inc(6096);
        __CLR4_4_14p64p6kylvdzts.R.inc(6098);this.messageDigest = messageDigest;
    }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}
    ...
    public MessageDigestCalculatingInputStream(final InputStream inputStream, final String algorithm)
        ...
        this(inputStream, MessageDigest.getInstance(algorithm));__CLR4_4_14p64p6kylvdzts.R.inc(6100);try{__CLR4_4_14p64p6kylvdzts.R.inc(6099);
    }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}
    ...
    public MessageDigestCalculatingInputStream(final InputStream inputStream) throws NoSuchAlgorithmException {
        this(inputStream, MessageDigest.getInstance("MD5"));__CLR4_4_14p64p6kylvdzts.R.inc(6102);try{__CLR4_4_14p64p6kylvdzts.R.inc(6101);
    }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}
     ...
     */
    public MessageDigest getMessageDigest() {try{__CLR4_4_14p64p6kylvdzts.R.inc(6103);
        __CLR4_4_14p64p6kylvdzts.R.inc(6104);return messageDigest;
    }finally{__CLR4_4_14p64p6kylvdzts.R.flushNeeded();}}
}
